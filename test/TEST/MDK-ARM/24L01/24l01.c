...
/**
  ...
  *@ref SPI_BaudRate_Prescaler:SPI_BAUDRATEPRESCALER_2~SPI_BAUDRATEPRESCALER_2 256
	*fAPB1时钟一般为42Mhz：
	*/
static void SPI2_SetSpeed(uint8_t SPI_BaudRatePrescaler)
{
...
uint8_t NRF24L01_Check(void)
{
	...
	SPI2_SetSpeed(SPI_BAUDRATEPRESCALER_8); //spi速度为8.0Mhz（（24L01的最大SPI时钟为10Mhz,这里大一点没关系）  
...
{
	uint8_t sta;
	SPI2_SetSpeed(SPI_BAUDRATEPRESCALER_8); //spi速度为4.0Mhz（24L01的最大SPI时钟为10Mhz） 
	NRF24L01_CE_LOW();
